...
test('sdk builders stay in strict account-order parity with the workspace protocol idl', () => {
  ...
  const buildByInstruction: Record<string, () => Transaction> = {
    activate_cycle_with_quote_sol: () => client.buildActivateCycleWithQuoteSolTx!({
    ...
    activate_cycle_with_quote_spl: () => client.buildActivateCycleWithQuoteSplTx!({
      payer: payer.toBase58(),
      member: member.toBase58(),
      poolAddress: pool.toBase58(),
      oracle: oracle.toBase58(),
    ...
    approve_coverage_claim: () => client.buildApproveCoverageClaimTx!({
      oracle: oracle.toBase58(),
      poolAddress: pool.toBase58(),
      member: member.toBase58(),
      seriesRefHashHex,
    ...
    attach_coverage_claim_decision_support: () => client.buildAttachCoverageClaimDecisionSupportTx!({
      oracle: oracle.toBase58(),
      poolAddress: pool.toBase58(),
      member: member.toBase58(),
      seriesRefHashHex,
    ...
    claim_oracle: () => client.buildClaimOracleTx!({
      oracle: oracle.toBase58(),
      recentBlockhash,
      programId: programId.toBase58(),
    }),
    cancel_pool_liquidity_redemption: () => client.buildCancelPoolLiquidityRedemptionTx!({
    ...
    claim_approved_coverage_payout: () => client.buildClaimApprovedCoveragePayoutTx!({
    ...
    backfill_schema_dependency_ledger: () => client.buildBackfillSchemaDependencyLedgerTx!({
      governanceAuthority: governanceAuthority.toBase58(),
      schemaKeyHashHex,
      recentBlockhash,
      programId: programId.toBase58(),
    }),
    close_coverage_claim: () => client.buildCloseCoverageClaimTx!({
    ...
    close_outcome_schema: () => client.buildCloseOutcomeSchemaTx!({
      governanceAuthority: governanceAuthority.toBase58(),
      schemaKeyHashHex,
      recipientSystemAccount: recipientSystemAccount.toBase58(),
      recentBlockhash,
    ...
    create_pool: () => client.buildCreatePoolTx!({
      authority: authority.toBase58(),
      poolId,
    ...
    deny_coverage_claim: () => client.buildDenyCoverageClaimTx!({
      oracle: oracle.toBase58(),
      poolAddress: pool.toBase58(),
      member: member.toBase58(),
      seriesRefHashHex,
    ...
    deposit_pool_liquidity_sol: () => client.buildDepositPoolLiquiditySolTx!({
    ...
    deposit_pool_liquidity_spl: () => client.buildDepositPoolLiquiditySplTx!({
      depositor: funder.toBase58(),
      poolAddress: pool.toBase58(),
      payoutMint: payoutMint.toBase58(),
    ...
    fail_pool_liquidity_redemption: () => client.buildFailPoolLiquidityRedemptionTx!({
      authority: authority.toBase58(),
      poolAddress: pool.toBase58(),
      redemptionRequest: redemptionRequest.toBase58(),
      redeemer: member.toBase58(),
    ...
    finalize_cohort_settlement_root: () => client.buildFinalizeCohortSettlementRootTx!({
      oracle: oracle.toBase58(),
      poolAddress: pool.toBase58(),
      seriesRefHashHex,
      payoutMint: payoutMint.toBase58(),
    ...
    fulfill_pool_liquidity_redemption_sol: () => client.buildFulfillPoolLiquidityRedemptionSolTx!({
      authority: authority.toBase58(),
      poolAddress: pool.toBase58(),
      redemptionRequest: redemptionRequest.toBase58(),
    ...
    fulfill_pool_liquidity_redemption_spl: () => client.buildFulfillPoolLiquidityRedemptionSplTx!({
      authority: authority.toBase58(),
      poolAddress: pool.toBase58(),
      payoutMint: payoutMint.toBase58(),
      redemptionRequest: redemptionRequest.toBase58(),
    ...
    initialize_pool_liquidity_sol: () => client.buildInitializePoolLiquiditySolTx!({
      authority: authority.toBase58(),
      poolAddress: pool.toBase58(),
      initialLamports: 50n,
      recentBlockhash,
    ...
    initialize_pool_liquidity_spl: () => client.buildInitializePoolLiquiditySplTx!({
      authority: authority.toBase58(),
      poolAddress: pool.toBase58(),
      payoutMint: payoutMint.toBase58(),
    ...
    initialize_protocol: () => client.buildInitializeProtocolTx!({
    ...
    issue_policy_position: () => client.buildIssuePolicyPositionTx!({
      authority: authority.toBase58(),
      poolAddress: pool.toBase58(),
      member: member.toBase58(),
      seriesRefHashHex,
    ...
    open_cycle_outcome_dispute: () => client.buildOpenCycleOutcomeDisputeTx!({
      authority: authority.toBase58(),
      poolAddress: pool.toBase58(),
    ...
    pay_coverage_claim: () => client.buildPayCoverageClaimTx!({
      authority: authority.toBase58(),
      claimant: claimant.toBase58(),
      poolAddress: pool.toBase58(),
      member: member.toBase58(),
    ...
    pay_premium_sol: () => client.buildPayPremiumSolTx!({
      payer: payer.toBase58(),
      poolAddress: pool.toBase58(),
      member: member.toBase58(),
      seriesRefHashHex,
    ...
    pay_premium_spl: () => client.buildPayPremiumSplTx!({
      payer: payer.toBase58(),
      poolAddress: pool.toBase58(),
      member: member.toBase58(),
      seriesRefHashHex,
    ...
    create_policy_series: () => client.buildCreatePolicySeriesTx!({
      authority: authority.toBase58(),
      poolAddress: pool.toBase58(),
      seriesRefHashHex,
      status: 1,
    ...
    upsert_policy_series_payment_option: () => client.buildUpsertPolicySeriesPaymentOptionTx!({
      authority: authority.toBase58(),
      poolAddress: pool.toBase58(),
      seriesRefHashHex,
      paymentMint: payoutMint.toBase58(),
    ...
    register_pool_capital_class: () => client.buildRegisterPoolCapitalClassTx!({
      authority: authority.toBase58(),
      poolAddress: pool.toBase58(),
    ...
    request_pool_liquidity_redemption: () => client.buildRequestPoolLiquidityRedemptionTx!({
      redeemer: member.toBase58(),
      poolAddress: pool.toBase58(),
      requestHashHex,
      sharesIn: 10n,
    ...
    resolve_cycle_outcome_dispute: () => client.buildResolveCycleOutcomeDisputeTx!({
      governanceAuthority: governanceAuthority.toBase58(),
      poolAddress: pool.toBase58(),
      payoutMint: payoutMint.toBase58(),
      aggregate: aggregate.toBase58(),
    ...
    review_coverage_claim: () => client.buildReviewCoverageClaimTx!({
      oracle: oracle.toBase58(),
      poolAddress: pool.toBase58(),
      member: member.toBase58(),
      seriesRefHashHex,
    ...
    schedule_pool_liquidity_redemption: () => client.buildSchedulePoolLiquidityRedemptionTx!({
      authority: authority.toBase58(),
      poolAddress: pool.toBase58(),
      redemptionRequest: redemptionRequest.toBase58(),
      includePoolControlAuthority: true,
    ...
    set_pool_automation_policy: () => client.buildSetPoolAutomationPolicyTx!({
      authority: authority.toBase58(),
      poolAddress: pool.toBase58(),
    ...
    set_pool_compliance_policy: () => client.buildSetPoolCompliancePolicyTx!({
      authority: authority.toBase58(),
      poolAddress: pool.toBase58(),
    ...
    set_pool_control_authorities: () => client.buildSetPoolControlAuthoritiesTx!({
      authority: authority.toBase58(),
      poolAddress: pool.toBase58(),
    ...
    set_pool_liquidity_enabled: () => client.buildSetPoolLiquidityEnabledTx!({
      authority: authority.toBase58(),
      poolAddress: pool.toBase58(),
      enabled: true,
      recentBlockhash,
    ...
    set_policy_series_outcome_rule: () => client.buildSetPolicySeriesOutcomeRuleTx!({
      authority: authority.toBase58(),
      poolAddress: pool.toBase58(),
      seriesRefHashHex,
      ruleHashHex,
    ...
    set_pool_risk_controls: () => client.buildSetPoolRiskControlsTx!({
      authority: authority.toBase58(),
      poolAddress: pool.toBase58(),
      payoutMint: payoutMint.toBase58(),
      redemptionMode: 2,
    ...
    subscribe_policy_series: () => client.buildSubscribePolicySeriesTx!({
      member: member.toBase58(),
      poolAddress: pool.toBase58(),
      seriesRefHashHex,
      startsAtTs: 1_700_000_000,
    ...
    update_policy_series: () => client.buildUpdatePolicySeriesTx!({
      authority: authority.toBase58(),
      poolAddress: pool.toBase58(),
      seriesRefHashHex,
      status: 1,
    ...
    redeem_pool_liquidity_sol: () => client.buildRedeemPoolLiquiditySolTx!({
      redeemer: member.toBase58(),
      poolAddress: pool.toBase58(),
      sharesIn: 10n,
      minAmountOut: 9n,
    ...
    redeem_pool_liquidity_spl: () => client.buildRedeemPoolLiquiditySplTx!({
      redeemer: member.toBase58(),
      poolAddress: pool.toBase58(),
      payoutMint: payoutMint.toBase58(),
      redeemerPayoutTokenAccount: recipientTokenAccount.toBase58(),
    ...
    update_oracle_profile: () => client.buildUpdateOracleProfileTx!({
      authority: authority.toBase58(),
      oracle: oracle.toBase58(),
      oracleType: 1,
  ...
  for (const instructionName of sdkInstructionNames) {
    ...
    const protocolInstructions = tx.instructions.filter((instruction) => instruction.programId.equals(programId));
    assert.equal(
    ...
    assert.equal(ix.keys.length, expectedAccounts.length + trailingAccounts.length, `${instructionName} account count mismatch`);
