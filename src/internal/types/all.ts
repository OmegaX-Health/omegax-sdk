...
export type ProtocolPoolStatus =
  | 'draft'
  | 'active'
  | 'paused'
  | 'closed'
...
export interface ProtocolClient
  extends ProtocolClientBuilders, ProtocolClientFetchers {
