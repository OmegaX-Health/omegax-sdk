...
const IX_INITIALIZE_PROTOCOL = anchorDiscriminator(
  'global',
  'initialize_protocol',
);
...
const IX_UPDATE_ORACLE_PROFILE = anchorDiscriminator(
  'global',
  'update_oracle_profile',
);
const IX_SET_POOL_ORACLE = anchorDiscriminator('global', 'set_pool_oracle');
const IX_SUBMIT_OUTCOME_ATTESTATION_VOTE = anchorDiscriminator(
  'global',
  'submit_outcome_attestation_vote',
);
const IX_FINALIZE_CYCLE_OUTCOME = anchorDiscriminator(
  'global',
  'finalize_cycle_outcome',
);
const IX_FINALIZE_COHORT_SETTLEMENT_ROOT = anchorDiscriminator(
  'global',
  'finalize_cohort_settlement_root',
);
const IX_SET_PROTOCOL_PARAMS = anchorDiscriminator(
  'global',
  'set_protocol_params',
);
const IX_ROTATE_GOVERNANCE_AUTHORITY = anchorDiscriminator(
  'global',
  'rotate_governance_authority',
);
const IX_UPDATE_ORACLE_METADATA = anchorDiscriminator(
  'global',
...
const IX_SET_POOL_ORACLE_POLICY = anchorDiscriminator(
  'global',
  'set_pool_oracle_policy',
);
const IX_SET_POOL_RISK_CONTROLS = anchorDiscriminator(
  'global',
  'set_pool_risk_controls',
);
const IX_SET_POOL_COMPLIANCE_POLICY = anchorDiscriminator(
  'global',
  'set_pool_compliance_policy',
);
const IX_SET_POOL_CONTROL_AUTHORITIES = anchorDiscriminator(
  'global',
  'set_pool_control_authorities',
);
const IX_SET_POOL_AUTOMATION_POLICY = anchorDiscriminator(
  'global',
  'set_pool_automation_policy',
);
const IX_SET_POOL_ORACLE_PERMISSIONS = anchorDiscriminator(
  'global',
  'set_pool_oracle_permissions',
);
const IX_SET_POOL_COVERAGE_RESERVE_FLOOR = anchorDiscriminator(
  'global',
  'set_pool_coverage_reserve_floor',
);
const IX_SET_POOL_TERMS_HASH = anchorDiscriminator(
  'global',
  'set_pool_terms_hash',
);
const IX_REGISTER_OUTCOME_SCHEMA = anchorDiscriminator(
  'global',
  'register_outcome_schema',
);
const IX_VERIFY_OUTCOME_SCHEMA = anchorDiscriminator(
  'global',
  'verify_outcome_schema',
);
const IX_BACKFILL_SCHEMA_DEPENDENCY_LEDGER = anchorDiscriminator(
  'global',
  'backfill_schema_dependency_ledger',
);
const IX_CLOSE_OUTCOME_SCHEMA = anchorDiscriminator(
  'global',
  'close_outcome_schema',
);
const IX_SET_POOL_OUTCOME_RULE = anchorDiscriminator(
  'global',
  'set_policy_series_outcome_rule',
);
const IX_REGISTER_INVITE_ISSUER = anchorDiscriminator(
  'global',
  'register_invite_issuer',
);
const IX_ENROLL_MEMBER_OPEN = anchorDiscriminator(
  'global',
  'enroll_member_open',
);
const IX_ENROLL_MEMBER_TOKEN_GATE = anchorDiscriminator(
  'global',
  'enroll_member_token_gate',
);
const IX_ENROLL_MEMBER_INVITE_PERMIT = anchorDiscriminator(
  'global',
  'enroll_member_invite_permit',
);
const IX_SET_CLAIM_DELEGATE = anchorDiscriminator(
  'global',
  'set_claim_delegate',
);
...
const IX_INITIALIZE_POOL_LIQUIDITY_SOL = anchorDiscriminator(
  'global',
  'initialize_pool_liquidity_sol',
);
const IX_INITIALIZE_POOL_LIQUIDITY_SPL = anchorDiscriminator(
  'global',
  'initialize_pool_liquidity_spl',
);
const IX_SET_POOL_LIQUIDITY_ENABLED = anchorDiscriminator(
  'global',
  'set_pool_liquidity_enabled',
);
const IX_REGISTER_POOL_CAPITAL_CLASS = anchorDiscriminator(
  'global',
  'register_pool_capital_class',
);
const IX_DEPOSIT_POOL_LIQUIDITY_SOL = anchorDiscriminator(
  'global',
  'deposit_pool_liquidity_sol',
);
const IX_DEPOSIT_POOL_LIQUIDITY_SPL = anchorDiscriminator(
  'global',
  'deposit_pool_liquidity_spl',
);
const IX_REDEEM_POOL_LIQUIDITY_SOL = anchorDiscriminator(
  'global',
  'redeem_pool_liquidity_sol',
);
const IX_REDEEM_POOL_LIQUIDITY_SPL = anchorDiscriminator(
  'global',
  'redeem_pool_liquidity_spl',
);
const IX_REQUEST_POOL_LIQUIDITY_REDEMPTION = anchorDiscriminator(
  'global',
  'request_pool_liquidity_redemption',
);
const IX_SCHEDULE_POOL_LIQUIDITY_REDEMPTION = anchorDiscriminator(
  'global',
  'schedule_pool_liquidity_redemption',
);
const IX_CANCEL_POOL_LIQUIDITY_REDEMPTION = anchorDiscriminator(
  'global',
  'cancel_pool_liquidity_redemption',
);
const IX_FAIL_POOL_LIQUIDITY_REDEMPTION = anchorDiscriminator(
  'global',
  'fail_pool_liquidity_redemption',
);
const IX_FULFILL_POOL_LIQUIDITY_REDEMPTION_SOL = anchorDiscriminator(
  'global',
  'fulfill_pool_liquidity_redemption_sol',
);
const IX_FULFILL_POOL_LIQUIDITY_REDEMPTION_SPL = anchorDiscriminator(
  'global',
  'fulfill_pool_liquidity_redemption_spl',
);
const IX_OPEN_CYCLE_OUTCOME_DISPUTE = anchorDiscriminator(
  'global',
  'open_cycle_outcome_dispute',
);
const IX_RESOLVE_CYCLE_OUTCOME_DISPUTE = anchorDiscriminator(
  'global',
  'resolve_cycle_outcome_dispute',
);
const IX_CREATE_POLICY_SERIES = anchorDiscriminator(
  'global',
  'create_policy_series',
);
const IX_UPSERT_POLICY_SERIES_PAYMENT_OPTION = anchorDiscriminator(
  'global',
  'upsert_policy_series_payment_option',
);
const IX_UPDATE_POLICY_SERIES = anchorDiscriminator(
  'global',
  'update_policy_series',
);
const IX_SUBSCRIBE_POLICY_SERIES = anchorDiscriminator(
  'global',
  'subscribe_policy_series',
);
const IX_ISSUE_POLICY_POSITION = anchorDiscriminator(
  'global',
...
const IX_ATTEST_PREMIUM_PAID_OFFCHAIN = anchorDiscriminator(
  'global',
  'attest_premium_paid_offchain',
);
const IX_SUBMIT_COVERAGE_CLAIM = anchorDiscriminator(
  'global',
  'submit_coverage_claim',
);
const IX_REVIEW_COVERAGE_CLAIM = anchorDiscriminator(
  'global',
  'review_coverage_claim',
);
const IX_ATTACH_COVERAGE_CLAIM_DECISION_SUPPORT = anchorDiscriminator(
  'global',
  'attach_coverage_claim_decision_support',
);
const IX_APPROVE_COVERAGE_CLAIM = anchorDiscriminator(
  'global',
  'approve_coverage_claim',
);
const IX_DENY_COVERAGE_CLAIM = anchorDiscriminator(
  'global',
  'deny_coverage_claim',
);
const IX_PAY_COVERAGE_CLAIM = anchorDiscriminator(
  'global',
  'pay_coverage_claim',
);
const IX_CLAIM_APPROVED_COVERAGE_PAYOUT = anchorDiscriminator(
  'global',
  'claim_approved_coverage_payout',
);
const IX_CLOSE_COVERAGE_CLAIM = anchorDiscriminator(
  'global',
  'close_coverage_claim',
);
const IX_SETTLE_COVERAGE_CLAIM = anchorDiscriminator(
  'global',
  'settle_coverage_claim',
);
const IX_ACTIVATE_CYCLE_WITH_QUOTE_SOL = anchorDiscriminator(
  'global',
  'activate_cycle_with_quote_sol',
);
const IX_ACTIVATE_CYCLE_WITH_QUOTE_SPL = anchorDiscriminator(
  'global',
  'activate_cycle_with_quote_spl',
);
const IX_SETTLE_CYCLE_COMMITMENT = anchorDiscriminator(
  'global',
  'settle_cycle_commitment',
);
const IX_SETTLE_CYCLE_COMMITMENT_SOL = anchorDiscriminator(
  'global',
  'settle_cycle_commitment_sol',
);
const IX_WITHDRAW_POOL_TREASURY_SPL = anchorDiscriminator(
  'global',
  'withdraw_pool_treasury_spl',
);
const IX_WITHDRAW_POOL_TREASURY_SOL = anchorDiscriminator(
  'global',
  'withdraw_pool_treasury_sol',
);
const IX_WITHDRAW_PROTOCOL_FEE_SPL = anchorDiscriminator(
  'global',
  'withdraw_protocol_fee_spl',
);
const IX_WITHDRAW_PROTOCOL_FEE_SOL = anchorDiscriminator(
  'global',
  'withdraw_protocol_fee_sol',
);
const IX_WITHDRAW_POOL_ORACLE_FEE_SPL = anchorDiscriminator(
  'global',
  'withdraw_pool_oracle_fee_spl',
);
const IX_WITHDRAW_POOL_ORACLE_FEE_SOL = anchorDiscriminator(
  'global',
  'withdraw_pool_oracle_fee_sol',
);

const ACCOUNT_PROTOCOL_CONFIG = anchorDiscriminator(
  'account',
  'ProtocolConfig',
);
const ACCOUNT_POOL = anchorDiscriminator('account', 'Pool');
const ACCOUNT_ORACLE_REGISTRY = anchorDiscriminator(
  'account',
  'OracleRegistryEntry',
);
const ACCOUNT_ORACLE_PROFILE = anchorDiscriminator('account', 'OracleProfile');
const ACCOUNT_POOL_ORACLE_APPROVAL = anchorDiscriminator(
  'account',
  'PoolOracleApproval',
);
const ACCOUNT_MEMBERSHIP_RECORD = anchorDiscriminator(
  'account',
  'MembershipRecord',
);
const ACCOUNT_CYCLE_OUTCOME = anchorDiscriminator(
  'account',
  'CycleOutcomeState',
);
const ACCOUNT_CLAIM_RECORD = anchorDiscriminator('account', 'ClaimRecord');
const ACCOUNT_CYCLE_OUTCOME_AGGREGATE = anchorDiscriminator(
  'account',
  'CycleOutcomeAggregate',
);
const ACCOUNT_ORACLE_STAKE_POSITION = anchorDiscriminator(
  'account',
  'OracleStakePosition',
);
const ACCOUNT_POOL_ORACLE_POLICY = anchorDiscriminator(
  'account',
  'PoolOraclePolicy',
);
const ACCOUNT_POOL_TERMS = anchorDiscriminator('account', 'PoolTerms');
const ACCOUNT_POOL_ASSET_VAULT = anchorDiscriminator(
  'account',
  'PoolAssetVault',
);
const ACCOUNT_POOL_LIQUIDITY_CONFIG = anchorDiscriminator(
  'account',
  'PoolLiquidityConfig',
);
const ACCOUNT_POOL_RISK_CONFIG = anchorDiscriminator(
  'account',
  'PoolRiskConfig',
);
const ACCOUNT_POOL_CAPITAL_CLASS = anchorDiscriminator(
  'account',
  'PoolCapitalClass',
);
const ACCOUNT_POOL_COMPLIANCE_POLICY = anchorDiscriminator(
  'account',
  'PoolCompliancePolicy',
);
const ACCOUNT_POOL_CONTROL_AUTHORITY = anchorDiscriminator(
  'account',
  'PoolControlAuthority',
);
const ACCOUNT_POOL_AUTOMATION_POLICY = anchorDiscriminator(
  'account',
  'PoolAutomationPolicy',
);
const ACCOUNT_PROTOCOL_FEE_VAULT = anchorDiscriminator(
  'account',
  'ProtocolFeeVault',
);
const ACCOUNT_POOL_ORACLE_FEE_VAULT = anchorDiscriminator(
  'account',
  'PoolOracleFeeVault',
);
const ACCOUNT_OUTCOME_SCHEMA = anchorDiscriminator(
  'account',
  'OutcomeSchemaRegistryEntry',
);
const ACCOUNT_SCHEMA_DEPENDENCY_LEDGER = anchorDiscriminator(
  'account',
  'SchemaDependencyLedger',
);
const ACCOUNT_POOL_OUTCOME_RULE = anchorDiscriminator(
  'account',
  'PoolOutcomeRule',
);
const ACCOUNT_INVITE_ISSUER = anchorDiscriminator(
  'account',
  'InviteIssuerRegistryEntry',
);
const ACCOUNT_CLAIM_DELEGATE_AUTH = anchorDiscriminator(
  'account',
  'ClaimDelegateAuthorization',
);
const ACCOUNT_COVERAGE_CLAIM_RECORD = anchorDiscriminator(
  'account',
  'CoverageClaimRecord',
);
const ACCOUNT_COVERAGE_POLICY_POSITION_NFT = anchorDiscriminator(
  'account',
  'PolicyPositionNft',
);
const ACCOUNT_COVERAGE_PRODUCT = anchorDiscriminator('account', 'PolicySeries');
const ACCOUNT_COVERAGE_PRODUCT_PAYMENT_OPTION = anchorDiscriminator(
  'account',
  'PolicySeriesPaymentOption',
);
const ACCOUNT_ENROLLMENT_PERMIT_REPLAY = anchorDiscriminator(
  'account',
  'EnrollmentPermitReplay',
);
const ACCOUNT_ATTESTATION_VOTE = anchorDiscriminator(
  'account',
  'AttestationVote',
);
const ACCOUNT_COVERAGE_POLICY = anchorDiscriminator(
  'account',
  'PolicyPosition',
);
const ACCOUNT_PREMIUM_LEDGER = anchorDiscriminator('account', 'PremiumLedger');
const ACCOUNT_PREMIUM_ATTESTATION_REPLAY = anchorDiscriminator(
  'account',
  'PremiumAttestationReplay',
);
const ACCOUNT_POOL_ORACLE_PERMISSION_SET = anchorDiscriminator(
  'account',
  'PoolOraclePermissionSet',
);
const ACCOUNT_MEMBER_CYCLE = anchorDiscriminator('account', 'MemberCycleState');
const ACCOUNT_CYCLE_QUOTE_REPLAY = anchorDiscriminator(
  'account',
  'CycleQuoteReplay',
);
const ACCOUNT_POOL_TREASURY_RESERVE = anchorDiscriminator(
  'account',
  'PoolTreasuryReserve',
);
const ACCOUNT_COHORT_SETTLEMENT_ROOT = anchorDiscriminator(
  'account',
  'CohortSettlementRoot',
);
const ACCOUNT_POOL_REDEMPTION_REQUEST = anchorDiscriminator(
  'account',
...
export function buildCycleQuoteMessage(
  fields: ProtocolCycleQuoteFields,
): Buffer {
...
export function buildCycleQuoteHash(
  input: ProtocolCycleQuoteFields | Uint8Array,
): Buffer {
...
export function decodeOracleRegistryEntryAccount(
  address: string,
  data: Buffer,
): ProtocolOracleRegistryEntryAccount {
...
export function decodeOracleProfileAccount(
  address: string,
  data: Buffer,
): ProtocolOracleProfileAccount {
...
export function decodePoolOracleApprovalAccount(
  address: string,
  data: Buffer,
): ProtocolPoolOracleApprovalAccount {
...
export function decodeMembershipRecordAccount(
  address: string,
  data: Buffer,
): ProtocolMembershipRecordAccount {
...
export function decodeCycleOutcomeAccount(
  address: string,
  data: Buffer,
): ProtocolCycleOutcomeAccount {
...
export function decodeCycleOutcomeAggregateAccount(
  address: string,
  data: Buffer,
): ProtocolCycleOutcomeAggregateAccount {
  ...
  offset += 32;
  const externalAttestationRefHashHex = toHex(
  ...
  offset += 32;
  const attestationProviderRefHashHex = toHex(
    data.subarray(offset, offset + 32),
  );
  offset += 32;
  const latestAsOfTs = Number(readI64Le(data, offset));
...
export function decodeOracleStakePositionAccount(
  address: string,
  data: Buffer,
): ProtocolOracleStakePositionAccount {
...
export function decodePoolOraclePolicyAccount(
  address: string,
  data: Buffer,
): ProtocolPoolOraclePolicyAccount {
...
export function decodePoolTermsAccount(
  address: string,
  data: Buffer,
): ProtocolPoolTermsAccount {
...
export function decodePoolAssetVaultAccount(
  address: string,
  data: Buffer,
): ProtocolPoolAssetVaultAccount {
...
export function decodePoolLiquidityConfigAccount(
  address: string,
  data: Buffer,
): ProtocolPoolLiquidityConfigAccount {
...
export function decodePoolRiskConfigAccount(
  address: string,
  data: Buffer,
): ProtocolPoolRiskConfigAccount {
...
export function decodePoolCapitalClassAccount(
  address: string,
  data: Buffer,
): ProtocolPoolCapitalClassAccount {
...
export function decodePoolCompliancePolicyAccount(
  address: string,
  data: Buffer,
): ProtocolPoolCompliancePolicyAccount {
...
export function decodePoolControlAuthorityAccount(
  address: string,
  data: Buffer,
): ProtocolPoolControlAuthorityAccount {
...
export function decodePoolAutomationPolicyAccount(
  address: string,
  data: Buffer,
): ProtocolPoolAutomationPolicyAccount {
  ...
  offset += 8;
  const requiredAttestationProviderRefHashHex = toHex(
    data.subarray(offset, offset + 32),
  );
  offset += 32;
  const updatedBy = pubkeyFromData(data, offset);
...
export function decodeProtocolFeeVaultAccount(
  address: string,
  data: Buffer,
): ProtocolFeeVaultAccount {
...
export function decodePoolOracleFeeVaultAccount(
  address: string,
  data: Buffer,
): ProtocolPoolOracleFeeVaultAccount {
...
export function decodePoolOraclePermissionSetAccount(
  address: string,
  data: Buffer,
): ProtocolPoolOraclePermissionSetAccount {
  if (!hasDiscriminator(data, ACCOUNT_POOL_ORACLE_PERMISSION_SET)) {
    throw new Error(
      'account discriminator mismatch for PoolOraclePermissionSet',
    );
  }
...
export function decodeMemberCycleAccount(
  address: string,
  data: Buffer,
): ProtocolMemberCycleAccount {
...
export function decodeCycleQuoteReplayAccount(
  address: string,
  data: Buffer,
): ProtocolCycleQuoteReplayAccount {
...
export function decodePoolTreasuryReserveAccount(
  address: string,
  data: Buffer,
): ProtocolPoolTreasuryReserveAccount {
...
export function decodeCohortSettlementRootAccount(
  address: string,
  data: Buffer,
): ProtocolCohortSettlementRootAccount {
...
export function decodeOutcomeSchemaAccount(
  address: string,
  data: Buffer,
): ProtocolOutcomeSchemaRegistryEntryAccount {
  if (!hasDiscriminator(data, ACCOUNT_OUTCOME_SCHEMA)) {
    throw new Error(
      'account discriminator mismatch for OutcomeSchemaRegistryEntry',
    );
  }
...
export function decodeSchemaDependencyLedgerAccount(
  address: string,
  data: Buffer,
): ProtocolSchemaDependencyLedgerAccount {
  if (!hasDiscriminator(data, ACCOUNT_SCHEMA_DEPENDENCY_LEDGER)) {
    throw new Error(
      'account discriminator mismatch for SchemaDependencyLedger',
    );
  }
...
export function decodePoolOutcomeRuleAccount(
  address: string,
  data: Buffer,
): ProtocolPoolOutcomeRuleAccount {
...
export function decodeInviteIssuerAccount(
  address: string,
  data: Buffer,
): ProtocolInviteIssuerRegistryEntryAccount {
  if (!hasDiscriminator(data, ACCOUNT_INVITE_ISSUER)) {
    throw new Error(
      'account discriminator mismatch for InviteIssuerRegistryEntry',
    );
  }
...
export function decodeEnrollmentPermitReplayAccount(
  address: string,
  data: Buffer,
): ProtocolEnrollmentPermitReplayAccount {
  if (!hasDiscriminator(data, ACCOUNT_ENROLLMENT_PERMIT_REPLAY)) {
    throw new Error(
      'account discriminator mismatch for EnrollmentPermitReplay',
    );
  }
...
export function decodeAttestationVoteAccount(
  address: string,
  data: Buffer,
): ProtocolAttestationVoteAccount {
...
export function decodeClaimDelegateAccount(
  address: string,
  data: Buffer,
): ProtocolClaimDelegateAuthorizationAccount {
  if (!hasDiscriminator(data, ACCOUNT_CLAIM_DELEGATE_AUTH)) {
    throw new Error(
      'account discriminator mismatch for ClaimDelegateAuthorization',
    );
  }
...
export function decodePolicyPositionAccount(
  address: string,
  data: Buffer,
): ProtocolPolicyPositionAccount {
...
export function decodePremiumLedgerAccount(
  address: string,
  data: Buffer,
): ProtocolPremiumLedgerAccount {
...
export function decodePolicySeriesAccount(
  address: string,
  data: Buffer,
): ProtocolPolicySeriesAccount {
...
export function decodePolicySeriesPaymentOptionAccount(
  address: string,
  data: Buffer,
): ProtocolPolicySeriesPaymentOptionAccount {
  if (!hasDiscriminator(data, ACCOUNT_COVERAGE_PRODUCT_PAYMENT_OPTION)) {
    throw new Error(
      'account discriminator mismatch for PolicySeriesPaymentOption',
    );
  }
...
export function decodePolicyPositionNftAccount(
  address: string,
  data: Buffer,
): ProtocolPolicyPositionNftAccount {
...
export function decodePremiumAttestationReplayAccount(
  address: string,
  data: Buffer,
): ProtocolPremiumAttestationReplayAccount {
  if (!hasDiscriminator(data, ACCOUNT_PREMIUM_ATTESTATION_REPLAY)) {
    throw new Error(
      'account discriminator mismatch for PremiumAttestationReplay',
    );
  }
...
export function decodeCoverageClaimRecordAccount(
  address: string,
  data: Buffer,
): ProtocolCoverageClaimRecordAccount {
  ...
  offset += 32;
  const aiExecutionEnvironmentHashHex = toHex(
    data.subarray(offset, offset + 32),
  );
  offset += 32;
...
export function decodePoolRedemptionRequestAccount(
  address: string,
  data: Buffer,
): ProtocolPoolRedemptionRequestAccount {
...
function normalize32ByteHexOrHash(
...
function encodeFixed32Vec(valuesHex: string[]): Buffer {
  ...
  if (count > MAX_ORACLE_SUPPORTED_SCHEMAS) {
    throw new Error(
      `supported schema key hashes cannot exceed ${MAX_ORACLE_SUPPORTED_SCHEMAS}`,
    );
  }
...
function encodeUpdateOracleProfileData(
  params: BuildUpdateOracleProfileTxParams,
): Buffer {
  return Buffer.concat([
...
function encodeInitializeProtocolData(
  params: BuildInitializeProtocolTxParams,
): Buffer {
  if (
  ...
  if (params.minOracleStake <= 0n) {
    throw new Error('minOracleStake must be greater than 0');
  }
  return Buffer.concat([
...
function encodeSetProtocolParamsData(
  params: BuildSetProtocolParamsTxParams,
): Buffer {
  if (
    !Number.isInteger(params.protocolFeeBps) ||
    params.protocolFeeBps < 0 ||
...
function encodeRotateGovernanceAuthorityData(
...
function encodeUpdateOracleMetadataData(
  params: BuildUpdateOracleMetadataTxParams,
): Buffer {
  return Buffer.concat([
...
function encodeSetPoolOraclePolicyData(
  params: BuildSetPoolOraclePolicyTxParams,
): Buffer {
  return Buffer.concat([
...
function encodeSetPoolRiskControlsData(
  params: BuildSetPoolRiskControlsTxParams,
): Buffer {
  return Buffer.concat([
...
function encodeWithdrawProtocolFeeSplData(
  params: BuildWithdrawProtocolFeeSplTxParams,
): Buffer {
  return Buffer.concat([
    IX_WITHDRAW_PROTOCOL_FEE_SPL,
    encodeU64Le(params.amount),
  ]);
}

function encodeWithdrawProtocolFeeSolData(
  params: BuildWithdrawProtocolFeeSolTxParams,
): Buffer {
  return Buffer.concat([
    IX_WITHDRAW_PROTOCOL_FEE_SOL,
    encodeU64Le(params.amount),
  ]);
}
...
function encodeSetPoolTermsHashData(
  params: BuildSetPoolTermsHashTxParams,
): Buffer {
  return Buffer.concat([
...
function encodeRegisterOutcomeSchemaData(
  params: BuildRegisterOutcomeSchemaTxParams,
): Buffer {
  return Buffer.concat([
...
function encodeVerifyOutcomeSchemaData(
  params: BuildVerifyOutcomeSchemaTxParams,
): Buffer {
  return Buffer.concat([
...
function encodeSetPoolOutcomeRuleData(
  params: BuildSetPoolOutcomeRuleTxParams,
): Buffer {
  return Buffer.concat([
...
function encodeRegisterInviteIssuerData(
  params: BuildRegisterInviteIssuerTxParams,
): Buffer {
  return Buffer.concat([
...
function encodeEnrollMemberOpenData(
  params: BuildEnrollMemberOpenTxParams,
): Buffer {
...
function encodeEnrollMemberTokenGateData(
  params: BuildEnrollMemberTokenGateTxParams,
): Buffer {
  const subjectCommitment = normalize32ByteHexOrHash(
    params.subjectCommitmentHex,
    `subject:${params.member}`,
...
function encodeSetClaimDelegateData(
  params: BuildSetClaimDelegateTxParams,
): Buffer {
  return Buffer.concat([
...
function encodeInitializePoolLiquiditySolData(
  ...
  return Buffer.concat([
    ...
    encodeU64Le(params.initialLamports),
  ]);
}
...
function encodeInitializePoolLiquiditySplData(
  ...
  return Buffer.concat([
    ...
    encodeU64Le(params.initialAmount),
  ]);
}
...
function encodeSubmitRewardClaimData(
  params: BuildSubmitRewardClaimTxParams,
): Buffer {
  return encodeSubmitRewardClaimPayload(params);
}

function encodeCreatePolicySeriesData(
...
function encodeUpdatePolicySeriesData(
...
function encodeSubscribePolicySeriesData(
...
function encodeSubmitCoverageClaimData(
  params: BuildSubmitCoverageClaimTxParams,
): Buffer {
  return Buffer.concat([
...
function encodeReviewCoverageClaimData(
  params: BuildReviewCoverageClaimTxParams,
): Buffer {
  return Buffer.concat([
...
function encodeApproveCoverageClaimData(
  params: BuildApproveCoverageClaimTxParams,
): Buffer {
  return Buffer.concat([
...
function encodeDenyCoverageClaimData(
  params: BuildDenyCoverageClaimTxParams,
): Buffer {
  return Buffer.concat([
...
function encodePayCoverageClaimData(
  params: BuildPayCoverageClaimTxParams,
): Buffer {
  return Buffer.concat([
    IX_PAY_COVERAGE_CLAIM,
...
function encodeCloseCoverageClaimData(
  params: BuildCloseCoverageClaimTxParams,
): Buffer {
  return Buffer.concat([
    IX_CLOSE_COVERAGE_CLAIM,
    encodeU64Le(params.recoveryAmount),
  ]);
}
...
function encodeSettleCoverageClaimData(
  params: BuildSettleCoverageClaimTxParams,
): Buffer {
  return Buffer.concat([
...
function buildActivateCycleWithQuoteSolTransaction(
  ...
  const quoteVerificationInstruction =
    buildCycleQuoteVerificationInstruction(params);
...
export function createProtocolBuilders(
  ...
  return {
    buildSubmitOutcomeAttestationVoteTx(
      ...
      const keys = [
        ...
        {
          pubkey: poolOraclePermissionsPda,
          isSigner: false,
          isWritable: false,
        },
    ...
    buildFinalizeCycleOutcomeTx(
      params: BuildFinalizeCycleOutcomeTxParams,
    ): Transaction {
    ...
    buildStakeOracleTx(params: BuildStakeOracleTxParams): Transaction {
      ...
      const instruction = new TransactionInstruction({
        ...
        keys: [
          ...
          {
            pubkey: new PublicKey(params.stakeMint),
            isSigner: false,
            isWritable: true,
          },
          {
            pubkey: new PublicKey(params.stakeVault),
            isSigner: true,
            isWritable: true,
          },
          {
            pubkey: new PublicKey(params.stakerTokenAccount),
            isSigner: false,
            isWritable: true,
          },
          { pubkey: TOKEN_PROGRAM_ID, isSigner: false, isWritable: false },
    ...
    buildFinalizeUnstakeTx(params: BuildFinalizeUnstakeTxParams): Transaction {
      ...
      const instruction = new TransactionInstruction({
        ...
        keys: [
          ...
          {
            pubkey: new PublicKey(params.destinationTokenAccount),
            isSigner: false,
            isWritable: true,
          },
          {
    ...
    buildSlashOracleTx(params: BuildSlashOracleTxParams): Transaction {
      ...
      const instruction = new TransactionInstruction({
        ...
        keys: [
          ...
          {
            pubkey: new PublicKey(params.slashTreasuryTokenAccount),
            isSigner: false,
            isWritable: true,
          },
          {
    ...
    buildSetPoolRiskControlsTx(
      ...
      const [poolControlAuthorityPda] = derivePoolControlAuthorityPda({
        programId,
        poolAddress,
      });
      const instruction = new TransactionInstruction({
    ...
    buildSetPoolControlAuthoritiesTx(
      ...
      const instruction = new TransactionInstruction({
        ...
        keys: [
          ...
          { pubkey: poolAddress, isSigner: false, isWritable: false },
          {
            pubkey: poolControlAuthorityPda,
            isSigner: false,
            isWritable: true,
          },
          {
    ...
    buildBackfillSchemaDependencyLedgerTx(
      ...
      const remainingAccounts = (params.poolRuleAddresses ?? []).map(
        (address) => ({
    ...
    buildCloseOutcomeSchemaTx(
      params: BuildCloseOutcomeSchemaTxParams,
    ): Transaction {
      const governanceAuthority = new PublicKey(params.governanceAuthority);
      const recipientSystemAccount = new PublicKey(
        params.recipientSystemAccount,
      );
      const schemaKeyHash = fromHex(params.schemaKeyHashHex, 32);
      const [configPda] = deriveConfigPda(programId);
    ...
    buildFundPoolSplTx(params: BuildFundPoolSplTxParams): Transaction {
      ...
      const instruction = new TransactionInstruction({
        ...
        keys: [
          ...
          { pubkey: poolVaultTokenAccount, isSigner: false, isWritable: true },
          {
            pubkey: new PublicKey(params.funderTokenAccount),
            isSigner: false,
            isWritable: true,
          },
          {
    ...
    buildInitializePoolLiquiditySolTx(
      ...
      const poolAddress = new PublicKey(params.poolAddress);
      const [poolTermsPda] = derivePoolTermsPda({ programId, poolAddress });
      const [poolLiquidityConfigPda] = derivePoolLiquidityConfigPda({
        programId,
        poolAddress,
      });
      const [poolShareMintPda] = derivePoolShareMintPda({
        programId,
        poolAddress,
      });
      ...
      const instruction = new TransactionInstruction({
        ...
        keys: [
          ...
          {
            pubkey: authorityShareTokenAccount,
            isSigner: false,
            isWritable: true,
          },
          { pubkey: TOKEN_PROGRAM_ID, isSigner: false, isWritable: false },
    ...
    buildInitializePoolLiquiditySplTx(
      ...
      const poolAddress = new PublicKey(params.poolAddress);
      const payoutMint = new PublicKey(params.payoutMint);
      const authorityPayoutTokenAccount = new PublicKey(
        params.authorityPayoutTokenAccount,
      );
      const [poolTermsPda] = derivePoolTermsPda({ programId, poolAddress });
      const [poolAssetVaultPda] = derivePoolAssetVaultPda({
        programId,
      ...
      const instruction = new TransactionInstruction({
        ...
        keys: [
          ...
          { pubkey: poolVaultTokenAccount, isSigner: false, isWritable: true },
          {
            pubkey: authorityPayoutTokenAccount,
            isSigner: false,
            isWritable: true,
          },
          { pubkey: poolLiquidityConfigPda, isSigner: false, isWritable: true },
    ...
    buildDepositPoolLiquiditySolTx(
      ...
      const keys = [
        ...
        { pubkey: poolShareMintPda, isSigner: false, isWritable: true },
        {
          pubkey: depositorShareTokenAccount,
          isSigner: false,
          isWritable: true,
        },
        { pubkey: TOKEN_PROGRAM_ID, isSigner: false, isWritable: false },
    ...
    buildDepositPoolLiquiditySplTx(
      ...
      const poolAddress = new PublicKey(params.poolAddress);
      const payoutMint = new PublicKey(params.payoutMint);
      const depositorPayoutTokenAccount = new PublicKey(
        params.depositorPayoutTokenAccount,
      );
      const [configPda] = deriveConfigPda(programId);
      const [poolTermsPda] = derivePoolTermsPda({ programId, poolAddress });
      const [poolAssetVaultPda] = derivePoolAssetVaultPda({
      ...
      const keys = [
        ...
        { pubkey: poolVaultTokenAccount, isSigner: false, isWritable: true },
        {
          pubkey: depositorPayoutTokenAccount,
          isSigner: false,
          isWritable: true,
        },
        { pubkey: poolLiquidityConfigPda, isSigner: false, isWritable: true },
    ...
    buildRedeemPoolLiquiditySolTx(
      ...
      const keys = [
        ...
        { pubkey: poolShareMintPda, isSigner: false, isWritable: true },
        {
          pubkey: redeemerShareTokenAccount,
          isSigner: false,
          isWritable: true,
        },
        { pubkey: TOKEN_PROGRAM_ID, isSigner: false, isWritable: false },
    ...
    buildRedeemPoolLiquiditySplTx(
      ...
      const poolAddress = new PublicKey(params.poolAddress);
      const payoutMint = new PublicKey(params.payoutMint);
      const redeemerPayoutTokenAccount = new PublicKey(
        params.redeemerPayoutTokenAccount,
      );
      const [configPda] = deriveConfigPda(programId);
      const [poolTermsPda] = derivePoolTermsPda({ programId, poolAddress });
      const [poolAssetVaultPda] = derivePoolAssetVaultPda({
      ...
      const keys = [
        ...
        { pubkey: poolVaultTokenAccount, isSigner: false, isWritable: true },
        {
          pubkey: redeemerPayoutTokenAccount,
          isSigner: false,
          isWritable: true,
        },
        { pubkey: poolLiquidityConfigPda, isSigner: false, isWritable: true },
    ...
    buildRequestPoolLiquidityRedemptionTx(
      ...
      const redeemer = new PublicKey(params.redeemer);
      const poolAddress = new PublicKey(params.poolAddress);
      const payoutMint = params.payoutMint
        ? new PublicKey(params.payoutMint)
    ...
    buildUpsertPolicySeriesPaymentOptionTx(
      ...
      const [coverageProductPaymentOptionPda] =
        derivePolicySeriesPaymentOptionPda({
          programId,
          poolAddress,
          seriesRefHash,
      ...
      const instruction = new TransactionInstruction({
        ...
        keys: [
          ...
          { pubkey: paymentMint, isSigner: false, isWritable: false },
          {
            pubkey: coverageProductPaymentOptionPda,
            isSigner: false,
            isWritable: true,
          },
          {
    ...
    buildAttachCoverageClaimDecisionSupportTx(
      ...
      const instruction = new TransactionInstruction({
        ...
        keys: [
          ...
          { pubkey: coverageClaimPda, isSigner: false, isWritable: true },
          {
            pubkey: poolAutomationPolicyPda,
            isSigner: false,
            isWritable: false,
          },
        ],
    ...
    buildClaimApprovedCoveragePayoutTx(
      ...
      const instruction = new TransactionInstruction({
        ...
        keys: [
          ...
          {
            pubkey: new PublicKey(params.poolAssetVault),
            isSigner: false,
            isWritable: false,
          },
          {
            pubkey: new PublicKey(params.poolVaultTokenAccount),
            isSigner: false,
            isWritable: true,
          },
          {
            pubkey: new PublicKey(params.recipientTokenAccount),
            isSigner: false,
            isWritable: true,
          },
          { pubkey: TOKEN_PROGRAM_ID, isSigner: false, isWritable: false },
...
export function createProtocolFetchers(
  connection: Connection,
  programId: PublicKey,
) {
  return {
    ...
    async fetchOracleRegistryEntry(
      oracle: string,
    ): Promise<ProtocolOracleRegistryEntryAccount | null> {
    ...
    async fetchOracleProfile(
      oracle: string,
    ): Promise<ProtocolOracleProfileAccount | null> {
    ...
    async fetchPoolTerms(
      poolAddress: string,
    ): Promise<ProtocolPoolTermsAccount | null> {
    ...
    async fetchPolicySeriesPaymentOption(params: {
      ...
      const account = await connection.getAccountInfo(pda, 'confirmed');
      if (!account) return null;
      return decodePolicySeriesPaymentOptionAccount(
        pda.toBase58(),
        account.data,
      );
    },
    ...
    async fetchPremiumAttestationReplay(params: {
      ...
      const account = await connection.getAccountInfo(pda, 'confirmed');
      if (!account) return null;
      return decodePremiumAttestationReplayAccount(
        pda.toBase58(),
        account.data,
      );
    },
    ...
    async fetchMemberCycle(params: {
      ...
      const [pda] = deriveMemberCyclePda({
        ...
        member: params.member,
        periodIndex:
          typeof params.periodIndex === 'bigint'
            ? params.periodIndex
...
export function createProtocolClient(
  ...
  return {
    connection,
    programId,
    ...createProtocolBuilders(connection, programId),
    ...createProtocolFetchers(connection, programId),
  };
}
